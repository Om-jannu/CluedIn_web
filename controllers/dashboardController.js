  ...
  get: (req, res) => {
    ...
    if (session.userid != null) {
      ...
      pool.query(qry, (err, result) => {
        ...
        res.render(Path, { message1: req.flash('message1'),err_message1: req.flash('err_message1'), label_data: label, bsd_data: bsd, userName: session.user_name, ProfileUrl: session.userProfileUrl, userRole:session.userRoleId });
      })
